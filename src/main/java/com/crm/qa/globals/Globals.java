...
public class Globals {
	...
	public static List<Map<String, String>> oracleDBData = new ArrayList<Map<String, String>>();
	 ...
	 *             IOException, AWTException VerifyTextPresent. To Verify if a text
	 *             is present on the page or not Also wait for text present. It can
	 *             also verify fade away messages.
	 * 
	 */
	 ...
	 *            timeout
	 * @throws HeadlessException,
	 *             IOException, AWTException VerifyTextNotPresent. To Verify if a
	 *             text is not present on the page Also wait for text not present.
	 *             It can also verify fade away messages.
	 * 
	 */
	 ...
	 * @author CHARAN REDDY
	 * @throws Exception
	 *             setUp. Invoke the browser automatically in each test case Also
	 *             maximize it and close any previous browser opened
	 * 
	 */
	...
	/**
	 * @author Charan browserSelectGrid. Presents capabilities to select browser on
	 *         Grid Browser - Chrome, firefox, IE 11
	 * 
	 */
